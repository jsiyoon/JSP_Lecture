...
<body>
	<div class="container">
		<div class="row">
			<div class="col-5">
			<h1>책 등록</h1>
				<form action="<%=request.getContextPath()%>/12jstl/25process.jsp" method="post">
					...
					<div class="form-group">
						<label for="writerHelp">작성자</label>
						<input type="text" name="writer" class="form-control" id="writerInput1">
					</div>
					<div class="form-group">
						<label for="priceInput">가격</label>
						<input type="text" name="price" class="form-control" id="priceInput1">
					</div>
					<div class="form-group">
						<label for="publisherHelp">출판사</label>
						<input type="text" name="publisher" class="form-control" id="publisherInput1">
					</div>
					<div class="form-group">
						<label for="stockHelp">재고</label>
						<input type="text" name="stock" class="form-control" id="stockInput1">
					</div>
