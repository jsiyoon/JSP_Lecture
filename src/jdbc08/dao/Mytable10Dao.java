...
public class Mytable10Dao {
	public boolean insert(Connection con, Bean10 bean) {
		String  sql = "INSERT INTO mytable10 (col1, col2, col3, col4, col5, col6, col7) VALUE (?, ?, ?, ?, ?, ?, ?)";
		try(PreparedStatement stmt = con.prepareStatement(sql)) {
			stmt.setInt(1, bean.getCol1());
			stmt.setDouble(2, bean.getCol2());
			stmt.setDouble(3, bean.getCol3());
			stmt.setString(4, bean.getCol4());
			stmt.setString(5, bean.getCol5());
			stmt.setDate(6, Date.valueOf(bean.getCol6()));
			stmt.setTimestamp(7, Timestamp.valueOf(bean.getCol7()));
